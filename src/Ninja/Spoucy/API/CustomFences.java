...
{   
    private final static String field_94464_a = "";
	public CustomFences(int id, Material material)
	{
		super(id, field_94464_a, material);
		this.setCreativeTab(SpoucyCore.tabSpoucyDecoration);
	}
